      ...
      <div className="flex items-center justify-center w-screen my-5">
        ...
        >
          <div className="grid grid-cols-2 gap-5">
            <div>
              ...
              <Input
                ...
                className="focus-visible:ring-0 my-1 hover:shadow-blue-400"
                ...
                <>
                  ...
                  <Select onValueChange={selectChangeHandler}>
                    <SelectTrigger className="w-[180px] my-1">
                      <SelectValue placeholder="Select a Company"  className="bg-gray-700 text-white"/>
                    </SelectTrigger>

                    <SelectContent className="bg-gray-900 text-white border border-gray-900">
                      <SelectGroup>
                        {companies.map((company) => (
                          <SelectItem
                            ...
                            className={
                              company.name.toLowerCase() === selectedCompanyValue
          ...
          <div className="flex items-center justify-center mt-5">
            {loading ? (
              <Button className="w-full px-4 py-2 text-white bg-black rounded-md">
